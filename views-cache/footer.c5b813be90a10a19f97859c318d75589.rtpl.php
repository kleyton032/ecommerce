            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Amazônia Store</h2>
                        <p>Os produtos que você curte e o melhor serviço da internet</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <p>deixe seu e-mail e receba as melhores ofertas!</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2018 Amazônia Express. <a href="http://www.hcode.com.br" target="_blank"></a></p>
                    </div>
                </div>
